...
class MerchantDependentAuthorizerTest {

    @InjectMocks
    MerchantDependentAuthorizer merchantDependentAuthorizer;
    ...
    @Test
    @DisplayName("Execute the merchant dependent authorizer strategy must throw a exception if cant find a merchant category by name")
    void test01() {
        givenAuthorizerFormWithoutMerchantName();
        whenExecuteSimpleAuthorizerShouldThrowExceptionForMerchantCategoryNotFound();
    }

    @Test
    @DisplayName("Execute the merchant dependent authorizer strategy must throw a exception if cant find the account")
    void test02() {
        givenAuthorizerFormWithFoodMerchantNameWithoutAccount();
        whenExecuteSimpleAuthorizerShouldThrowExceptionForAccountNotFound();
    }

    @Test
    @DisplayName("Execute the merchant dependent authorizer strategy must add the transaction to the account and save it")
    void test03() {
        givenValidAuthorizerFormWithFoodMerchantName();
    ...
    @Test
    @DisplayName("isSatisfiedBy of the merchant dependent authorizer strategy must return false when given null form")
    void test04() {
    ...
    @Test
    @DisplayName("isSatisfiedBy of the merchant dependent authorizer strategy must return false when given a valid form with no existing match for the merchant name")
    void test05() {
        givenAuthorizerFormWithoutMerchantName();
        whenCheckingIfIsSatisfiedBy();
        thenSatisfiedByShouldBeFalse();
    ...
    @Test
    @DisplayName("isSatisfiedBy of the merchant dependent authorizer strategy must return true when given a valid form with existing match for the merchant name")
    void test06() {
        givenValidAuthorizerFormWithFoodMerchantName();
        whenCheckingIfIsSatisfiedBy();
    ...
    private void givenAuthorizerFormWithoutMerchantName() {
        authorizerForm = new AuthorizerForm("", BigDecimal.TEN, "", "");
    }

    private void givenValidAuthorizerFormWithFoodMerchantName() {
        authorizerForm = new AuthorizerForm("123", BigDecimal.TEN, "", "UBER EATS");
    }

    private void givenAuthorizerFormWithFoodMerchantNameWithoutAccount() {
        authorizerForm = new AuthorizerForm("", BigDecimal.TEN, "", "UBER EATS");
    }
    ...
    private void whenCheckingIfIsSatisfiedBy() {
        satisfiedBy = merchantDependentAuthorizer.isSatisfiedBy(authorizerForm);
    }
    ...
    private void whenExecuteSimpleAuthorizerShouldThrowExceptionForMerchantCategoryNotFound() {
        ...
        exception = assertThrows(MerchantCategoryNotFoundException.class, () -> merchantDependentAuthorizer.execute(authorizerForm));
    ...
    private void whenExecuteSimpleAuthorizerShouldThrowExceptionForAccountNotFound() {
        ...
        exception = assertThrows(AccountNotFoundException.class, () -> merchantDependentAuthorizer.execute(authorizerForm));
    ...
    private void whenExecuteSimpleAuthorizer() {
        merchantDependentAuthorizer.execute(authorizerForm);
    }
